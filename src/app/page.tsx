...
export default function Home() {
  return (
    <div>
      ...
      <div className="w-full"><Image width={100} height={100} src="/Group 11.png" alt="" /></div>
      <div>
    ...
    <section className="container xl:width-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 items-center mb-20">
      ...
      <div >
        <Image className="w-full" width={500} height={500} src="/Rectangle 6.png" alt="" />
      </div>
    </section>
    <section className="container xl:width-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 md:gap-x-4 mt-10">
      <div className="grid grid-cols-2 gap-x-2"><div className=""><Image width={500} height={100}  src="/Rectangle 8.png" alt=""/><Image width={500} height={100} className="py-3" src="/Rectangle 10.png" alt=""/></div><div className="mt-8"><Image width={500} height={100} src="/Rectangle 9.png" alt=""/></div></div>
      <div className="">
    ...
    <div className="grid grid-cols-2 mt-5"><div className=" xl:grid grid-cols-6"><Image width={500} height={100} className="xl:col-span-1" src="/1 (1).png" alt=""/><p className="xl:col-span-2 xl:leading-[38px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed efficitur, lectus et facilisis placerat.</p></div>
    <div className=" xl:grid grid-cols-6"><Image width={500} height={100} className="xl:col-span-1" src="/2 (1).png" alt=""/><p  className="xl:col-span-3 xl:ms-9 xl:leading-[38px]">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed efficitur, lectus et facilisis placerat, magna mauris porttitor tortor, a auctor est felis ut nisl.</p></div></div>
         ...
         <section className="container xl:width-[1440px] mx-auto my-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-x-10 gap-y-10 mt-10"><div className="md:col-span-2 relative"><Image width={500} height={100} className="w-full hover:brightness-75" src="/Rectangle 12.png" alt=""/><div className="absolute top-4">asd</div></div>
          <div className="md:col-span-2 "><Image width={500} height={100} className="w-full" src="/image 15.png" alt=""/></div>
          <div className="md:col-span-1"><Image width={500} height={100} className="w-full h-[80%]" src="/image 16.png" alt=""/></div>
          <div className="md:col-span-2"><Image width={500} height={100} className="w-full  h-[80%]" src="/image 17.png" alt=""/></div>
          <div className="md:col-span-1"><Image width={500} height={100} className="w-full h-[80%]" src="/image 18.png" alt=""/></div></div>
         </section>
         ...
         <section className="container xl:width-[1440px] mx-auto">
          ...
          <div className="col-span-2"><Image width={500} height={100} className="col-span-1 w-full " src="/image 12.png" alt=""/></div></div>
          
         </section>


         <footer className=" xl:width-[1440px] mx-auto grid grid-cols-2 md:grid-cols-4 gap-x-10 gap-y-20 mt-10 text-white bg-[#333333] ps-9 py-20">
<Image width={200} height={100} className="" src="/Group 11 1.png" alt="logo"/>
...
<li><Image width={10} height={10} className="inline-block " src="/icons/facebook.svg" alt=""/> <Image width={35} height={35} className="inline-block ps-5" src="/icons/Shape.svg" alt=""/><Image width={35} height={35} className="inline-block ps-5" src="/icons/Linked In.svg" alt=""/><Image width={35} height={35} className="inline-block ps-5" src="/icons/pininterest.svg" alt=""/></li></ul>
        </footer>
